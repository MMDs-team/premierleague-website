...
export const ClubStatsCard = ({data,name}) => {
  ...
  return (
            ...
            <li>
                <div data-stat-header="topClubs" className="top-stats">{console.log(data)}
                    
                <header>
                    <h4 class="top-stats__title"><a href="/stats/top/clubs/goals?se=578">{name}</a></h4>
                </header>
                <div class="top-stats__wrapper">

                    <ul class="top-stats__list">
                        {data.map((club, index) => (

                            <li class="top-stats__hero t43 inactive top-stats__hero--top-player">
                                <svg class="top-stats__svg-decoration" viewBox="300 130 800 100" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
                                        <defs> 
                                ...
                                <a class="top-stats__hero-link" href="/clubs/11/Man-City/overview">
