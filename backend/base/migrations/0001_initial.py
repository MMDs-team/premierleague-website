...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Employee',
            fields=[
                ('employee', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='employee_user', serialize=False, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            name='Referee',
            fields=[
                ('referee', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='referee_user', serialize=False, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample_club', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='kit_sample_club', to='base.sampleclub')),
            ],
        ),
        migrations.CreateModel(
            name='SamplePlayer',
        ...
        migrations.AddField(
            model_name='club',
            name='main_stadium',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='club_club_stad', to='base.stadium'),
        ),
        migrations.AddField(
            model_name='club',
            name='stadiums',
