...
export const PlayerStatsCard = ({data, type, name}) => {
  ...
  return (
            ...
            <li>{console.log(data)}
                <div data-stat-header="topPerformers" className="top-stats">{console.log("data:",data)}
                    
                        <header>
                            <h4 className="top-stats__title"><a href="/stats/top/players/goals?se=578">{name}</a></h4>

                            <div className="top-stats__wrapper">

                                <ul className="top-stats__list">

                                    {data.length > 0 &&<li className="top-stats__hero t43  ">
                                     ...
                                     {data.length > 1 &&  data.slice(1, data.length).map((item, index) => (
