...
def stats_top_club(request):
    ...
    response = {}
    match action_type:
        case 'win': response = count_club_matches(season, lambda self, other: self > other)
        case 'lose': response = count_club_matches(season, lambda self, other: self < other)
        case 'clean_sheet': response = count_club_matches(season, lambda self, other: other == 0)

        case 'goal': response = count_club_actions(season, action_type=ACTIONS['goal'])
        case 'yellow_card': response = count_club_actions(season, action_type=ACTIONS['yellow_card'], subject=False)
        case 'red_card': response = count_club_actions(season, action_type=ACTIONS['red_card'], subject=False)
        case 'shot': response = count_club_actions(season, action_type=ACTIONS['shot'])
        case 'goal_from_header': response = count_club_actions(season, action_type=ACTIONS['goal_from_header'])
        case 'goal_from_penalty': response = count_club_actions(season, action_type=ACTIONS['goal_from_penalty'])
        case 'goal_from_freekick': response = count_club_actions(season, action_type=ACTIONS['goal_from_freekick'])
        case 'goal_from_inside_box': response = count_club_actions(season, action_type=ACTIONS['goal_from_inside_box'])
        case 'goal_from_outside_box': response = count_club_actions(season, action_type=ACTIONS['goal_from_outside_box'])
        case 'goal_from_counter_attack': response = count_club_actions(season, action_type=ACTIONS['goal_from_counter_attack'])
        case 'offside': response = count_club_actions(season, action_type=ACTIONS['offside'], subject=False)
        case 'save': response = count_club_actions(season, action_type=ACTIONS['save'])
        case 'tackle': response = count_club_actions(season, action_type=ACTIONS['tackle'])
        case 'own_goal': response = count_club_actions(season, action_type=ACTIONS['own_goal'])
        case 'foul': response = count_club_actions(season, action_type=ACTIONS['foul'])
        case 'penalty': response = count_club_actions(season, action_type=ACTIONS['penalty'])
        case 'pass': response = count_club_actions(season, action_type=ACTIONS['pass'])
        case 'cross': response = count_club_actions(season, action_type=ACTIONS['cross'])
        case 'corner': response = count_club_actions(season, action_type=ACTIONS['corner'])
        case _: response = {
...
def stats_top_player(request):
    ...
    match action_type:
        ...
        case 'save': response = count_player_actions(season, club, position, nationality, ACTIONS['save'])
        case 'assist': response = count_player_actions(season, club, position, nationality, ACTIONS['assist'])
        case 'appearance': response = count_player_actions(season, club, position, nationality, ACTIONS['appearance'])
        case 'yellow_card': response = count_player_actions(season, club, position, nationality, ACTIONS['yellow_card'], subject=False)
        case 'red_card': response = count_player_actions(season, club, position, nationality, ACTIONS['red_card'], subject=False)
        case 'shot': response = count_player_actions(season, club, position, nationality, ACTIONS['shot'])
        case 'goal_from_header': response = count_player_actions(season, club, position, nationality, ACTIONS['goal_from_header'])
        case 'goal_from_panalty': response = count_player_actions(season, club, position, nationality, ACTIONS['goal_from_penalty'])
        case 'goal_from_freekick': response = count_player_actions(season, club, position, nationality, ACTIONS['goal_from_freekick'])
        case 'offside': response = count_player_actions(season, club, position, nationality, ACTIONS['offside'])
        case 'pass': response = count_player_actions(season, club, position, nationality, ACTIONS['pass'])
        case 'cross': response = count_player_actions(season, club, position, nationality, ACTIONS['cross'])
        case 'corner': response = count_player_actions(season, club, position, nationality, ACTIONS['corner'])
        case 'tackle': response = count_player_actions(season, club, position, nationality, ACTIONS['tackle'])
        # case 'own_goal': response = count_player_actions(season, club, position, nationality, ACTIONS['own_goal'])
        case 'clean_sheet': response = count_player_actions(season, club, position, nationality, ACTIONS['clean_sheet'])
        case 'penalty': 
