                            ...
                            <header>
                                ...
                                <div className="top-stats__wrapper">
                                    ...
                                    <ul className="top-stats__list">
                                        ...
                                        {stats[stat].length > 1 &&  stats[stat].slice(1, stats[stat].length).map((item, index) => (
                                            

                                            <li className="top-stats__row top-stats__row--" key={index}>
                                                ...
                                                <div className="top-stats__row-team-info">
                                                    ...
                                                    <a href="/clubs/4/Chelsea/overview" className="top-stats__row-team-name"></a>
                                                </div>
                                                </div>
                                                <div className="top-stats__row-stat">
                                                {item[stat]}
                                                </div>
                                            </li>
                                            ))
                                    ...
                                    <a className="top-stats__button global-btn" href="/stats/top/players/goals?se=578">
                                        View Full List
                                        <svg className="icon " aria-hidden="true">
                                            <use xlink="http://www.w3.org/1999/xlink" href="https://www.premierleague.com/resources/rebrand/v7.149.0/i/svg-output/icons.svg#icn-arrow-right"></use>
                                        </svg>
                                    </a>
